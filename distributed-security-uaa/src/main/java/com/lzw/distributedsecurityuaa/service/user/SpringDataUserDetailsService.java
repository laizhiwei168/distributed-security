package com.lzw.distributedsecurityuaa.service.user;
   ...
   // private UserDao userDao;
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
       ...
       // System.out.println("username="+s+"    "+user.getPassword());
        ...
        // 暂时采用模拟方式
        UserDetails userDetails = User.withUsername(s).password("$2a$10$6VVoQjq4Lh5j6m/q4LCIgeR3CUxchzAGAfloRJZbSmDDEsgMKGSva").authorities(sts).build();
        return userDetails;
